...
# ==========================================
# APLICANDO FILTROS AOS DADOS DO MAPA
# ==========================================
...
# Filtrar mapa por município se selecionado
...
with col2:
    ...
    # Lógica corrigida para o Gráfico de Barras reativo por Município
    if municipio_selecionado == "Todos os Municípios (Visão Geral)":
        ...
        # Filtra especificamente para o município selecionado na barra lateral
