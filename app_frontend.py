...
with col1:
    st.subheader(f"🗺️ Mapa de Calor e Dispersão (Risco de Acidentes)")
    ...
    # Substituído por px.scatter_mapbox para garantir que valores baixos também exibam cor visível e precisa
    fig = px.scatter_mapbox(
        df_mapa, 
        lat='latitude', 
        lon='longitude', 
        color='acidentes_previstos',
        size='acidentes_previstos',
        size_max=15,
        zoom=zoom, 
