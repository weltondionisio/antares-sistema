...
def carregar_dados():
    ...
    # TRATAMENTO DE ESCALA: Ajuste o FATOR_DIVISAO se precisar normalizar os valores brutos do modelo
    FATOR_DIVISAO = 1.0  
...
# Tratamento logarítmico para suavizar o heatmap contínuo e evitar distorções visuais
...
with col2:
    ...
    if mes_selec == "Ano":
        ...
        # Gráfico de barras exibe a SOMA total de cada mês
        ...
        # Gráfico de barras exibe a MEDIANA mensal
