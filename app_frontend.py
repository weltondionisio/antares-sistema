...
def carregar_dados():
    ...
    # Substitui por nome por extenso se for código, mantendo o nome caso já seja textual
...
# Tratamento para o Mapa: Agrupamento em modo "Ano" para evitar sobreposição excessiva de pontos
if mes_selec == "Ano":
...
with col1:
    st.subheader(f"🗺️ Mapa de Calor (Risco de Acidentes)")
    ...
    fig = px.density_mapbox(
        ...
        color_continuous_scale="Reds"  # Cores em tons de vermelho (claro para ralo, escuro para denso)
    )
