...
# Função auxiliar para formatar números no padrão brasileiro (Ponto para milhar, Vírgula para decimal)
def formatar_br(valor):
    if pd.isna(valor):
        return "0,00"
    # Formata com 2 casas decimais, troca ponto por marcador temporário, vírgula por ponto e marcador por vírgula
...
def carregar_dados():
    ...
    # TRATAMENTO DE ESCALA: Reativado para dividir por 1000 e trazer para a escala correta
...
# Tratamento logarítmico para suavizar o heatmap contínuo
