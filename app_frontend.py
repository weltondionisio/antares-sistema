...
def carregar_dados():
    ...
    # Assegurar que estado e municipio sejam estritamente strings para evitar bugs nos filtros
...
# Tratamento para o Mapa: Se estiver no modo "Ano", agrupamos por coordenada para evitar sobreposições pesadas
if mes_selec == "Ano":
